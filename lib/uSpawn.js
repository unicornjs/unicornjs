...
function math(){
    ...
    console.log('Old uMath function in uSpawn.js called, this function will be removed in next version');
    // Forward the promise, this is a bit hacky but the function will be removed
    spawnService('uMath', 'core-service', false).then(function(msg){
...
function broker(){
    // Like run the test before we start a broker or service bla
    console.log('Old broker function in uSpawn.js called, this function will be removed in next version');
    // Forward the promise, this is a bit hacky but the function will be removed
    return new unicorn.promise(function(resolve, reject){
        spawnService('uBroker', 'core-service', true).then(function(msg){
            resolve(msg);
        });
    });
